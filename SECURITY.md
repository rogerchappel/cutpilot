...
Replace this section with the supported versions for `cutpilot`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `cutpilot` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in cutpilot.
